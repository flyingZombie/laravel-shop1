    ...
    export default {
        ...
        data() {
            return {
                 ...
                 *
                 * @type {}
                 * @link https://developers.google.com/maps/documentation/javascript/reference/places-service#PlaceResult.address_components
                 */
                addressComponents: {},
        ...
        methods: {
            ...
            onPlaceChanged() {
                ...
                if (place.address_components !== undefined) {
                    ...
                    this.addressComponents = this.formatResult(place)
                    this.onChange()
                }
            },
            ...
            onChange() {
              ...
              this.$emit('change', this.addressComponents);
            },
